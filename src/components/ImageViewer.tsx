  ...
  return (
    <div className="bg-foreground/95 rounded-lg overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center min-h-[400px]">
        <FileImage className="w-12 h-12 text-primary-foreground/20 mb-3" />
        <p className="text-sm text-primary-foreground/50">Geen DICOM-data beschikbaar</p>
        <p className="text-xs text-primary-foreground/30 mt-1">Dit beeld is niet opgenomen in de testdata</p>
      </div>
    </div>
  );
}
